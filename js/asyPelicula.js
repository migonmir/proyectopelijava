        ...
        // funcion que crea las tarjetas de peliculas
           ...
           // card.classList.add( 'contenedorAclamada');
            // estamos creando la tarjeta
            const cardInner = document.createElement('div');
            //cardInner.classList.add('.contenedorCarddiv');
            // creo la imagen de la tarjeta
            const cardImg = document.createElement('img');
           // cardImg.classList.add('.contenedorCarddivimg');
        ...
        const cargarPeliculas = async (page = 1) => {
            try{
                ...
                //console.log(movies);
                const peliculasSection = document.getElementById('asypelisection');
         ...
         document.addEventListener("DOMContentLoaded", () => { 
            const  cargarPeliculasButton = document.getElementById('btnApi');
